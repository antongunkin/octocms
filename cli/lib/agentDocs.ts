...
export function generateAgentOverview(cfg: Config, collectionNames: readonly string[]): string {
  ...
  lines.push(
    'The data model is defined in **`cms/schema.json`** — the source of truth. It is plain JSON, hand-editable, and the visual Content Model editor at `/cms/content-model` writes to the same file.',
    '',
